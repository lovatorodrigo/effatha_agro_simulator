...
class _SimulationDashboardState extends State<SimulationDashboard>
  ...
  Widget _buildTabBar(ThemeData theme, bool isDark) {
    return Container(
      ...
      child: const TabBar(
        // (pode trocar por AppLocalizations se quiser)
        tabs: [
          Tab(text: 'Dashboard'),
          Tab(text: 'Settings'),
          Tab(text: 'Profile'),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // === Profitability Analysis (card branco) =========================
            SizedBox(height: 3.h),
            Container(
              decoration: BoxDecoration(
                ...
                children: [
                  ...
                  ProgressIndicatorWidget(
                    ...
                    value: double.tryParse(
                            _effathaResults['roi']?.replaceAll('%', '') ??
                                '0') ??
                        0,
                    maxValue: 100,
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // (Mantido conforme o atual do projeto)
                Text(
                  'Currency Settings',
                ...
                DropdownButtonFormField<String>(
                  ...
                  // REMOVIDO const: há AppLocalizations dentro
                  ...
                  items: [
                    DropdownMenuItem(
                        value: 'hectares',
                        child: Text(
                            AppLocalizations.of(context)!.hectares)),
                    DropdownMenuItem(
                        value: 'acres',
                        child:
